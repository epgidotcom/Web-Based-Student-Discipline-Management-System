...
form.addEventListener("submit", function (event) {
  ...
  if (
    (usernameInput === adminCredentials.username || usernameInput === adminCredentials.email) &&
  ...
  if (
    (usernameInput === studentCredentials.username || usernameInput === studentCredentials.email) &&
    passwordInput === studentCredentials.password
  ) {

  // Student login success
  window.location.href = "../MPNAG_student/student_dashboard.html";
