...
form?.addEventListener("submit", function (event) {
  ...
  // Credentials check
  const userOk = (usernameInput === validUsername || usernameInput === validEmail);
  const passOk = (passwordInput === validPassword);
  ...
  if (userOk && passOk) {
    ...
    if (errorMessage) errorMessage.textContent = "Invalid username/email or password!";
